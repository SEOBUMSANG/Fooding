    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tMapView.setOnMarkerClickEvent(new TMapView.OnCalloutMarker2ClickCallback() {
            ...
            public void onCalloutMarker2ClickEvent(String s, TMapMarkerItem2 tMapMarkerItem2) {
                ...
                try {
                    DBHelper.insertLikeData(marker.target.getName(),   // DB에 추가
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (makeBigMarker(global.getTargetListArray(), bigMarkerList)) {    // 마커 생성
                    ...
                    //로칼 DB
                    DBHelper.openDatabase(getApplicationContext(), "fooding");    //단말용 전체 DB
                    DBHelper.createTable("likes");    //시청 목록 용 테이블
                }
            }
        }).start();
