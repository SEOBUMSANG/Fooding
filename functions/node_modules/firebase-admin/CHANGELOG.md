...
- [added] Added the email action URL generation APIs for creating links for
  password reset, email verification and email URL sign-in via
...
- [changed] Fixed an issue that caused an `auth/internal-error` error to be
  ...
  for a user without a creation description.
