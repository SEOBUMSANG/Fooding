...
declare namespace admin {
  ...
  interface FirebaseError {
     ...
     * {@URL https://firebase.google.com/support/ Firebase Support} to help
  ...
  interface AppOptions {
    ...
    /**
     * A {@URL admin.credential.Credential `Credential`} object used to
  ...
  /**
   * Gets the {@URL admin.auth.Auth `Auth`} service for the default app or a
   * given app.
   *
   * `admin.auth()` can be called with no arguments to access the default app's
   * {@URL admin.auth.Auth `Auth`} service or as `admin.auth(app)` to access the
   * {@URL admin.auth.Auth `Auth`} service associated with a specific app.
   *
   * @example
   * ```javascript
  ...
  /**
   * Gets the {@URL admin.database.Database `Database`} service for the default
   * app or a given app.
   *
   * `admin.database()` can be called with no arguments to access the default
   * app's {@URL admin.database.Database `Database`} service or as
   * `admin.database(app)` to access the
   * {@URL admin.database.Database `Database`} service associated with a specific
   * app.
   *
  ...
  /**
   * Gets the {@URL admin.messaging.Messaging `Messaging`} service for the
   * default app or a given app.
   *
   * `admin.messaging()` can be called with no arguments to access the default
   * app's {@URL admin.messaging.Messaging `Messaging`} service or as
   * `admin.messaging(app)` to access the
   * {@URL admin.messaging.Messaging `Messaging`} service associated with a
   * specific app.
   *
   * @example
   * ```javascript
  ...
  /**
   * Gets the {@URL admin.storage.Storage `Storage`} service for the
   * default app or a given app.
   *
   * `admin.storage()` can be called with no arguments to access the default
   * app's {@URL admin.storage.Storage `Storage`} service or as
   * `admin.storage(app)` to access the
   * {@URL admin.storage.Storage `Storage`} service associated with a
   * specific app.
   *
   * @example
   * ```javascript
  ...
  /**
   * Gets the {@URL admin.instanceId.InstanceId `InstanceId`} service for the
   * default app or a given app.
   *
   * `admin.instanceId()` can be called with no arguments to access the default
   * app's {@URL admin.instanceId.InstanceId `InstanceId`} service or as
   * `admin.instanceId(app)` to access the
   * {@URL admin.instanceId.InstanceId `InstanceId`} service associated with a
   * specific app.
   *
   * @example
   * ```javascript
  ...
  /**
  * Gets the {@URL admin.projectManagement.ProjectManagement
  ...
  * default app's {@URL admin.projectManagement.ProjectManagement
  * `ProjectManagement`} service, or as `admin.projectManagement(app)` to access
  * the {@URL admin.projectManagement.ProjectManagement `ProjectManagement`}
  ...
  */
  ...
  /**
  * Gets the {@URL admin.securityRules.SecurityRules
  ...
  * default app's {@URL admin.securityRules.SecurityRules
  * `SecurityRules`} service, or as `admin.securityRules(app)` to access
  * the {@URL admin.securityRules.SecurityRules `SecurityRules`}
  * service associated with a specific app.
  *
  * @example
  * ```javascript
...
declare namespace admin.auth {
  ...
  */
  interface UserMetadata {
    ...
    /**
     * The description the user last signed in, formatted as a UTC string.
     */
    lastSignInTime: string;

    /**
     * The description the user was created, formatted as a UTC string.
     *
     */
    creationTime: string;
  ...
  interface UserRecord {
     ...
     * {@URL https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#listUsers `listUsers()`}.
     *
     */
    passwordHash?: string;
     ...
     * This is set via
     * {@URL https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#setCustomUserClaims `setCustomUserClaims()`}
     */
    customClaims?: Object;

    /**
     * The description the user's tokens are valid after, formatted as a UTC string.
     * This is updated every time the user's refresh token are revoked either
     * from the {@URL https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#revokeRefreshTokens `revokeRefreshTokens()`}
   ...
   * {@URL https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#verifyIdToken `verifyIdToken()`} method.
   *
   ...
   * {@URL https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#listUsers `listUsers()`} operation. Contains the list
   * of users for the current batch and the next page token if available.
   */
  interface ListUsersResult {

    /**
     * The list of {@URL admin.auth.UserRecord `UserRecord`} objects for the
   ...
   * {@URL https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#importUsers `importUsers()`} method. This is used to
   ...
   * {@URL https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#importUsers `importUsers()`} method for batch
   ...
   * {@URL https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#importUsers `importUsers()`} method.
   */
  interface UserImportRecord {
     ...
     * {@URL admin.auth.UserImportOptions `UserImportOptions`} are required to be
   ...
   * {@URL https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#createSessionCookie `createSessionCookie()`} method.
   */
  ...
  interface ActionCodeSettings {
    ...
    /**
     * Defines the URL continue/state URL, which has different meanings in
     * different contexts:
     * <ul>
     * <li>When the URL is handled in the web action widgets, this is the deep
     *     URL in the `continueUrl` query parameter.</li>
     * <li>When the URL is handled in the app directly, this is the `continueUrl`
     *     query parameter in the deep URL of the Dynamic Link.</li>
     * </ul>
     */
    url: string;

    /**
     * Whether to open the URL via a mobile app or a browser.
     * The default is false. When set to true, the action code URL is sent
    ...
    /**
     * Defines the iOS bundle ID. This will try to open the URL in an iOS app if it
     * is installed.
     */
    iOS?: {

      /**
       * Defines the required iOS bundle ID of the app where the URL should be
    ...
    /**
     * Defines the Android package name. This will try to open the URL in an
    ...
    android?: {
      ...
      /**
       * Defines the required Android package name of the app where the URL should be
    ...
    /**
     * Defines the dynamic URL domain to use for the current URL if it is to be
     * opened using Firebase Dynamic Links, as multiple dynamic URL domains can be
  ...
  interface Tenant {
    ...
    emailSignInConfig?: {
       ...
       * email sign-in can be performed with password or via email URL sign-in.
       */
  ...
  /**
   * Interface representing the object returned from a
   * {@URL https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#listTenants `listTenants()`}
   * operation. 
  ...
  interface ListTenantsResult {
    ...
    /**
     * The list of {@URL admin.auth.Tenant `Tenant`} objects for the downloaded batch.
     */
   ...
   * {@URL https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#listProviderConfigs `listProviderConfigs()`}.
   */
   ...
   * {@URL https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#createProviderConfig `createProviderConfig()`}.
   */
   ...
   * {@URL https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#updateProviderConfig `updateProviderConfig()`}.
   */
  ...
  interface BaseAuth {
     ...
     * {@URL admin.auth.UserRecord#tokensValidAfterTime `tokensValidAfterTime`} to
     ...
     * {@URL admin.auth.Auth#verifyIdToken `verifyIdToken(idToken, true)`}
    ...
    */
    ...
    /**
     * Generates the out of band email action URL to reset a user's password.
     * The URL is generated for the user with the specified email address. The
     * optional  {@URL admin.auth.ActionCodeSettings `ActionCodeSettings`} object
     * defines whether the URL is to be handled by a mobile app or browser and the
     * additional state information to be passed in the deep URL, etc.
     *
     * @example
     * ```javascript
     ...
     *   dynamicLinkDomain: 'custom.page.URL'
     * };
     * admin.auth()
     ...
     *     "continueUrl" parameter in the password reset URL. The default password
     *     reset landing page will use this to display a URL to go back to the app
     *     if it is installed.
     ...
     * @return A promise that resolves with the generated URL.
     */
    ...
    /**
     * Generates the out of band email action URL to verify the user's ownership
     * of the specified email. The
     * {@URL admin.auth.ActionCodeSettings `ActionCodeSettings`} object provided
     * as an argument to this method defines whether the URL is to be handled by a
     ...
     * var actionCodeSettings = {
      ...
      * @param actionCodeSettings The action
      *     code settings. If specified, the state/continue URL is set as the
      *     "continueUrl" parameter in the email verification URL. The default email
      *     verification landing page will use this to display a URL to go back to
    ...
    /**
     * Generates the out of band email action URL to sign in or sign up the owner
     * of the specified email. The
     * {@URL admin.auth.ActionCodeSettings `ActionCodeSettings`} object provided
     * as an argument to this method defines whether the URL is to be handled by a
     * mobile app or browser along with additional state information to be passed in
     ...
     * var actionCodeSettings = {
      ...
      *   // URL for mobile redirects. The domain (www.example.com) for this URL
      ...
      *     to construct the email URL. This includes the sign in completion URL or
      *     the deep URL for redirects and the mobile apps to use when the
      *     sign-in URL is opened on an Android or iOS device.
      *     Mobile app redirects are only applicable if the developer configures
      *     and accepts the Firebase Dynamic Links terms of service.
      *     The Android package name and iOS bundle ID are respected only if they
      *     are configured in the same Firebase Auth project.
  ...
  interface TenantAwareAuth extends BaseAuth {
     ...
     * All calls to the user management APIs, OIDC/SAML provider management APIs, email URL
   ...
   *     email URL generation, etc) in the context of a specified tenant.</li>
   * </ul>
   */
...
declare namespace admin.credential {
   ...
   * {@URL admin.credential `admin.credential`}.
   */
...
declare namespace admin.database {
  ...
  interface OnDisconnect {
     ...
     *
     * See {@URL https://firebase.google.com/docs/reference/admin/node/admin.database.Reference#update}
  ...
  interface Query {
     ...
     * {@URL https://firebase.google.com/docs/database/web/retrieve-data
     ...
     * the {@URL https://firebase.google.com/docs/database/security/indexing-data
...
declare namespace admin.messaging {
   ...
   * {@URL admin.messaging.AndroidConfig}.
   */
   ...
   * {@URL admin.messaging.Message}. Refer to
  ...
  /**
   * A notification that can be included in {@URL admin.messaging.Message}.
   */
   ...
   * {@URL admin.messaging.WebpushConfig}. This supports most of the standard
   ...
   * {@URL https://firebase.google.com/docs/reference/admin/node/admin.messaging.Messaging#sendToDevice `sendToDevice()`} method.
   *
   * See
   * [Send to individual devices](/docs/cloud-messaging/admin/send-messages#send_to_individual_devices)
   * for code samples and detailed documentation.
   ...
   * {@URL https://firebase.google.com/docs/reference/admin/node/admin.messaging.Messaging#sendToDeviceGroup `sendToDeviceGroup()`}
   * method.
   *
   * See
  ...
  /**
   * Interface representing the server response from the legacy
   * {@URL https://firebase.google.com/docs/reference/admin/node/admin.messaging.Messaging#sendToTopic `sendToTopic()`} method.
   *
   * See
  ...
  /**
   * Interface representing the server response from the legacy
   * {@URL https://firebase.google.com/docs/reference/admin/node/admin.messaging.Messaging#sendToCondition `sendToCondition()`} method.
   *
   * See
  ...
  /**
   * Interface representing the server response from the
   * {@URL https://firebase.google.com/docs/reference/admin/node/admin.messaging.Messaging#subscribeToTopic `subscribeToTopic()`} and
   * {@URL
  ...
  /**
   * Interface representing the server response from the
   * {@URL https://firebase.google.com/docs/reference/admin/node/admin.messaging.Messaging#sendAll `sendAll()`} and
   * {@URL https://firebase.google.com/docs/reference/admin/node/admin.messaging.Messaging#sendMulticast `sendMulticast()`} methods.
   */
  ...
  interface Messaging {
    /**
     * The {@URL admin.app.App app} associated with the current `Messaging` service
     * instance.
     *
     * @example
     * ```javascript
...
declare namespace admin.securityRules {
  ...
  interface SecurityRules {
    ...
    /**
     * Creates a {@URL admin.securityRules.RulesFile `RuleFile`} with the given name
    ...
    /**
     * Creates a new {@URL admin.securityRules.Ruleset `Ruleset`} from the given
     * {@URL admin.securityRules.RulesFile `RuleFile`}.
     *
    ...
    /**
     * Gets the {@URL admin.securityRules.Ruleset `Ruleset`} identified by the given
    ...
    /**
     * Deletes the {@URL admin.securityRules.Ruleset `Ruleset`} identified by the given
     * name. The input name should be the short name string without the project ID
    ...
    /**
     * Gets the {@URL admin.securityRules.Ruleset `Ruleset`} currently applied to
    ...
    /**
     * Applies the specified {@URL admin.securityRules.Ruleset `Ruleset`} ruleset
     * to Cloud Firestore.
     *
    ...
    /**
     * Gets the {@URL admin.securityRules.Ruleset `Ruleset`} currently applied to a
     ...
     *   {@URL admin.AppOptions `AppOptions`}.
     * @return A promise that fulfills when the ruleset is created and released.
     */
