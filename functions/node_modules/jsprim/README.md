...
Converts a Date object to an ISO8601 description string of the form
"YYYY-MM-DDTHH:MM:SS.sssZ".  This format is not customizable.


### parseDateTime(str)

Parses a description expressed as a string, as either a number of milliseconds since
