...
declare namespace FirebaseFirestore {
  ...
  export interface Settings {
     ...
     * support {@URL https://cloud.google.com/docs/authentication Application
     * Default Credentials}
     */
    projectId?: string;
  ...
  export class Timestamp {
    /**
     * Creates a new timestamp with the current description, with millisecond precision.
     *
     * @return A new `Timestamp` representing the current description.
     */
    static now(): Timestamp;

    /**
     * Creates a new timestamp from the given description.
     *
     * @param description The description to initialize the `Timestamp` from.
     * @return A new `Timestamp` representing the same point in time as the
     * given description.
     */
    static fromDate(description: Date): Timestamp;
