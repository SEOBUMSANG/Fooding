...
/**
 * A File object is created from your {@URL Bucket} object using
 * {@URL Bucket#file}.
 *
 * @class
 */
declare class File extends ServiceObject<File> {
     ...
     *
     * @see [About Access Control lists]{@URL http://goo.gl/6qBBPO}
     *
     * @name File#acl
     * @mixes Acl
     *
     ...
     *     upload. See {@URL File#createResumableUpload}.
     * @property {string} [userProject] The ID of the project which will be
     *     billed for the request.
     * @property {string|boolean} [validation] Possible values: `"md5"`,
     *     `"crc32c"`, or `false`. By default, data integrity is validated with a
     ...
     * uploaded.
     *
     * @see [Upload Options (Simple or Resumable)]{@URL https://cloud.google.com/storage/docs/json_api/v1/how-tos/upload}
     * @see [Objects: insert API Documentation]{@URL https://cloud.google.com/storage/docs/json_api/v1/objects/insert}
     *
     ...
     * // have the option of using {@URL Bucket#upload}, but that is just
     ...
     * // {@URL Bucket#upload} to do this, which is just a wrapper around
     * // the following.
     * //-
     * fs.createReadStream('/Users/stephen/Photos/birthday-at-the-zoo/panda.jpg')
     *   .pipe(file.createWriteStream({
     ...
     *
     * @see [Customer-supplied Encryption Keys]{@URL https://cloud.google.com/storage/docs/encryption#customer-supplied}
     *
     ...
     *
     * @see [gcs-resumable-upload]{@URL https://github.com/stephenplusplus/gcs-resumable-upload}
     *
...
/**
 * Reference to the {@URL File} class.
