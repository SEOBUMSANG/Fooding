 ...
 * service account through the {@URL Storage} client using
 * {@URL Storage#createHmacKey}.
 *
 * @see [HMAC keys documentation]{@URL https://cloud.google.com/storage/docs/authentication/hmackeys}
 *
 * @class
 */
export declare class HmacKey extends ServiceObject<HmacKeyMetadata | undefined> {
     ...
     * an HMAC key, use {@URL Storage#createHmacKey}.
     *
