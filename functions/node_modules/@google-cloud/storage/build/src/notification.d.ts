 ...
 * @property {Notification} 0 The {@URL Notification}
 * @property {object} 1 The full API response.
 */
 ...
 * @param {?Error} err Request error, if any.
 * @param {Notification} notification The {@URL Notification}.
 * @param {object} apiResponse The full API response.
 */
...
/**
 * A Notification object is created from your {@URL Bucket} object using
 * {@URL Bucket#notification}. Use it to interact with Cloud Pub/Sub
 * notifications.
 *
 * @see [Cloud Pub/Sub Notifications for Google Cloud Storage]{@URL https://cloud.google.com/storage/docs/pubsub-notifications}
 *
 * @class
 * @hideconstructor
 *
...
/**
 * Reference to the {@URL Notification} class.
