 ...
 * @hideconstructor
 *
 * @param {Storage} storage A {@URL Storage} instance.
...
declare class Bucket extends ServiceObject {
    ...
    name: string;
    /**
     * A reference to the {@URL Storage} associated with this {@URL Bucket}
     * instance.
     * @name Bucket#storage
     * @type {Storage}
     */
     ...
     * {@URL Bucket#acl.default}.
     *
     * @see [About Access Control Lists]{@URL http://goo.gl/6qBBPO}
     * @see [Default ACLs]{@URL https://cloud.google.com/storage/docs/access-control/lists#default}
     *
     * @name Bucket#acl
     * @mixes Acl
    ...
    iam: Iam;
    /**
     * Get {@URL File} objects for the files currently in the bucket as a
     * readable object stream.
     *
     * @method Bucket#getFilesStream
     * @param {GetFilesOptions} [query] Query object for listing files.
     * @returns {ReadableStream} A readable stream that emits {@URL File} instances.
     *
     * @example
     * const {Storage} = require('@google-cloud/storage');
     * const storage = new Storage();
    ...
    /**
     * Create a {@URL File} object. See {@URL File} to see how to handle
...
/**
 * Reference to the {@URL Bucket} class.
