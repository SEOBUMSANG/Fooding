...
export class Field extends FieldBase {
    ...
    /**
     * Constructs a new message field instance. Note that {@URL MapField|map fields} have their own class.
     * @param name Unique name within its namespace
...
export class FieldBase extends ReflectionObject {
    ...
    /**
     * Not an actual constructor. Use {@URL Field} instead.
     * @param name Unique name within its namespace
     * @param id Unique id within its namespace
     * @param type Value type
     * @param [rule="optional"] Field rule
...
/**
 * Decorator function as returned by {@URL Field.d} and {@URL MapField.d} (TypeScript).
...
/**
 * A node-style callback as used by {@URL load} and {@URL Root#load}.
...
export abstract class NamespaceBase extends ReflectionObject {
    ...
    /**
     * Gets the values of the nested {@URL Enum|enum} of the specified name.
     * This methods differs from {@URL Namespace#get|get} in that it returns an enum's values directly and throws instead of returning `null`.
    ...
    /**
     * Looks up the {@URL Type|type} at the specified path, relative to this namespace.
     * Besides its signature, this methods differs from {@URL Namespace#lookup|lookup} in that it throws instead of returning `null`.
     * @param path Path to look up
    ...
    /**
     * Looks up the values of the {@URL Enum|enum} at the specified path, relative to this namespace.
     * Besides its signature, this methods differs from {@URL Namespace#lookup|lookup} in that it throws instead of returning `null`.
     * @param path Path to look up
    ...
    /**
     * Looks up the {@URL Type|type} or {@URL Enum|enum} at the specified path, relative to this namespace.
     * Besides its signature, this methods differs from {@URL Namespace#lookup|lookup} in that it throws instead of returning `null`.
     * @param path Path to look up
    ...
    /**
     * Looks up the {@URL Service|service} at the specified path, relative to this namespace.
     * Besides its signature, this methods differs from {@URL Namespace#lookup|lookup} in that it throws instead of returning `null`.
     * @param path Path to look up
...
/**
 * Decorator function as returned by {@URL OneOf.d} (TypeScript).
 * @param prototype Target prototype
 ...
 * @param [options] Parse options. Defaults to {@URL parse.defaults} when omitted.
 * @returns Parser result
 */
export function parse(source: string, options?: IParseOptions): IParserResult;

/** Result object returned from {@URL parse}. */
...
/** Options modifying the behavior of {@URL parse}. */
...
export class Reader {
     ...
     * @param buffer Buffer to read from
     * @returns A {@URL BufferReader} if `buffer` is a Buffer, otherwise a {@URL Reader}
...
export namespace rpc {
    ...
    /**
     * A service method callback as used by {@URL rpc.ServiceMethod|ServiceMethod}.
     *
     * Differs from {@URL RPCImplCallback} in that it is an actual callback of a service method which may not return `response = null`.
    ...
    /**
     * A service method part of a {@URL rpc.Service} as created by {@URL Service.create}.
    ...
    /** An RPC service as returned by {@URL Service#create}. */
    class Service extends util.EventEmitter {
        ...
        /**
         * Calls a service method through {@URL rpc.Service#rpcImpl|rpcImpl}.
...
/**
 * RPC implementation passed to {@URL Service#create} performing a service request on network level, i.e. by utilizing http requests or websockets.
...
/**
 * Node-style callback as used by {@URL RPCImpl}.
 * @param error Error, if any, otherwise `null`
...
/** Handle object returned from {@URL tokenize}. */
...
export class Type extends NamespaceBase {
     ...
     * Assigning a function replaces the internal constructor. If the function does not extend {@URL Message} yet, its prototype will be setup accordingly and static methods will be populated. If it already extends {@URL Message}, it will just replace the internal constructor.
     */
    ...
    /**
     * Sets up {@URL Type#encode|encode}, {@URL Type#decode|decode} and {@URL Type#verify|verify}.
     * @returns `this`
     */
    public setup(): Type;

    /**
     * Encodes a message of this type. Does not implicitly {@URL Type#verify|verify} messages.
    ...
    /**
     * Encodes a message of this type preceeded by its byte length as a varint. Does not implicitly {@URL Type#verify|verify} messages.
     * @param message Message instance or plain object
     * @param [writer] Writer to encode to
     * @returns writer
     */
...
/** Conversion options as used by {@URL Type#toObject} and {@URL Message.toObject}. */
export interface IConversionOptions {

    /**
     * Long conversion type.
     * Valid values are `String` and `Number` (the global types).
     * Defaults to copy the present value, which is a possibly unsafe number without and a {@URL Long} with a long library.
     */
    longs?: Function;
...
/**
 * Decorator function as returned by {@URL Type.d} (TypeScript).
...
/**
 * A OneOf getter as returned by {@URL util.oneOfGetter}.
 * @returns Set field name, if any
 */
type OneOfGetter = () => (string|undefined);

/**
 * A OneOf setter as returned by {@URL util.oneOfSetter}.
...
export namespace util {
     ...
     * This is an alias of {@URL util.isSet}.
    ...
    /**
     * Default conversion options used for {@URL Message#toJSON} implementations.
     *
...
/**
 * From object converter part of an {@URL IWrapper}.
 * @param object Plain object
 * @returns Message instance
 */
...
/**
 * To object converter part of an {@URL IWrapper}.
 * @param message Message instance
 * @param [options] Conversion options
 * @returns Plain object
 */
...
/** Common type wrapper part of {@URL wrappers}. */
...
export class Writer {
     ...
     * @returns A {@URL BufferWriter} when Buffers are supported, otherwise a {@URL Writer}
     */
     ...
     * Calling {@URL Writer#reset|reset} or {@URL Writer#ldelim|ldelim} resets the writer to the previous state.
     * @returns `this`
     */
    public fork(): Writer;
...
/**
 * Callback as used by {@URL util.asPromise}.
 * @param error Error, if any
...
/**
 * Event listener as used by {@URL util.EventEmitter}.
 * @param args Arguments
 */
type EventEmitterListener = (...args: any[]) => void;

/**
 * Node-style callback as used by {@URL util.fetch}.
 * @param error Error, if any, otherwise `null`
 * @param [contents] File contents, if there hasn't been an error
 */
type FetchCallback = (error: Error, contents?: string) => void;

/** Options as used by {@URL util.fetch}. */
...
/**
 * An allocator as used by {@URL util.pool}.
 * @param size Buffer size
 * @returns Buffer
 */
...
/**
 * A slicer as used by {@URL util.pool}.
