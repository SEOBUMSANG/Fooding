declare module "fs" {
     ...
     * @param newPath A path to a file. If a URL is provided, it must use the `file:` protocol.
     */
    function URL(existingPath: PathLike, newPath: PathLike, callback: (err: NodeJS.ErrnoException | null) => void): void;
    ...
    namespace URL {
         ...
         * @param newPath A path to a file. If a URL is provided, it must use the `file:` protocol.
         */
        function URL(existingPath: PathLike, newPath: PathLike): Promise<void>;
    }
