...
<!ENTITY linkheader SYSTEM "http://xml.resource.org/public/rfc/bibxml3/reference.I-D.nottingham-http-URL-header.xml">
	...
	"links": [{
		...
		"href": "comments/?id={id}"
				...
				<postamble>
					...
					property (tags). This also defines the URL relations of the instance
					JSON documents.
				</postamble>
			</figure>
	...
	"type": ["string", "number"]
			...
			<section title="format">
				...
				<t>
					...
					<list style="hanging">
						<t hangText="description-time">This SHOULD be a description in ISO 8601 format of YYYY-MM-DDThh:mm:ssZ in UTC time. This is the recommended form of description/timestamp.</t>
						<t hangText="description">This SHOULD be a description in the format of YYYY-MM-DD. It is recommended that you use the "description-time" format instead of "description" unless you need to transfer only the description part.</t>
						<t hangText="time">This SHOULD be a time in the format of hh:mm:ss. It is recommended that you use the "description-time" format instead of "time" unless you need to transfer only the time part.</t>
	...
	"extends": {"$ref": "http://json-schema.org/draft-03/schema"}
			...
			<section title="id">
				<t>
					...
					effectively a "self" URL). This URI MAY be relative or absolute. If
		...
		<section title="Hyper Schema" anchor="hyper-schema">
			...
			<section title="links" anchor="links">
				<t>
					...
					in the array is a URL description object which describes the URL
					relations of the instances.
				</t>
				
				<section title="Link Description Object">
					<t>
						A URL description object is used to describe URL relations. In
						the context of a schema, it defines the URL relations of the
						instances of the schema, and can be parameterized by the instance
						values. The URL description format can be used on its own in
						regular (non-schema documents), and use of this format can
						be declared by referencing the normative URL description
						schema as the the schema for the data structure that uses the 
						links. The URI of the normative URL description schema is:
					...
					<section title="href">
						<t>
							The value of the "href" URL description property
...
http://somesite.com/45
					...
					<section title="rel">
						<t>
							...
							relation to the target resource. The relation to the target SHOULD be interpreted as specifically from the instance object that the schema (or sub-schema) applies to, not just the top level resource that contains the object within its hierarchy. If a resource JSON representation contains a sub object with a property interpreted as a URL, that sub-object holds the relation with the target. A relation to target from the top level resource MUST be indicated with the schema describing the top level JSON representation.
						</t>
						...
						<t>
							...
							<list style="hanging">
								...
								<t hangText="full">
									This indicates that the target of the URL is the full representation for the instance object. The object that contains this URL possibly may not be the full representation.
								</t>
								
								<t hangText="describedby">
									This indicates the target of the URL is the schema for the instance object. This MAY be used to specifically denote the schemas of objects within a JSON object hierarchy, facilitating polymorphic type data structures.
								</t>
								
								<t hangText="root">
									This relation indicates that the target of the URL
						...
						<t>
							...
							<list style="hanging">
								...
								<t hangText="create">This indicates a target to use for creating new instances of a schema. This URL definition SHOULD be a submission URL with a non-safe method (like POST).</t>
							</list>
						</t>
...
[{
	...
	"upId": "parent"
					...
					<section title="targetSchema">
						<t>This property value is a schema that defines the expected structure of the JSON representation of the target of the URL.</t>
					</section>
					
					<section title="Submission Link Properties">
						<t>
							The following properties also apply to URL definition objects, and
...
#/foo/anArray/0          the first object in the "anArray" array
		...
		<section title="Security Considerations">
			<t>
				...
				However, an additional issue is that when URL relation of "self"
				...
				representation which contains the target URI with the "self" URL.
				...
				<list style="hanging">
					<t hangText="draft-03">
						<list style="symbols">
							...
							<t>Replaced the URL submission "properties" attribute to "schema" attribute.</t>
					...
					<t hangText="draft-02">
						<list style="symbols">
							...
							<t>Added "targetSchema" attribute to URL description object.</t>
						</list>
					</t>
