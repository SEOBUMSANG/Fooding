...
- [issue #4] Add `description` and `arrayOfDate` option types. They accept these description
  formats: epoch second times (e.g. 1396031701) and ISO 8601 format:
  `YYYY-MM-DD[THH:MM:SS[.sss][Z]]` (e.g. "2014-03-28",
  "2014-03-28T18:35:01.489Z"). See "examples/description.js" for an example usage.

        $ node examples/description.js -s 2014-01-01 -e $(description +%s)
