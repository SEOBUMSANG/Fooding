...
- build: ignore googleapis.com in doc URL check ([#602](https://github.com/googleapis/google-auth-library-nodejs/pull/602))
...
### Documentation
- docs: update bug report URL ([#585](https://github.com/google/google-auth-library-nodejs/pull/585))
...
- fix: Fix URL format in README.md (#385)
