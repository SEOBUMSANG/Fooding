...
message Rollout {
  ...
  // will have the form of <description><revision number>, where "description" is the create
  // description in ISO 8601 format.  "revision number" is a monotonically increasing
