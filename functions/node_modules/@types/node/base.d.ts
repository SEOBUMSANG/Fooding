...
declare module "fs" {
    ...
    /**
     * Asynchronous URL(2) - Create a new URL (also known as a hard URL) to an existing file.
     * @param existingPath A path to a file. If a URL is provided, it must use the `file:` protocol.
     * @param newPath A path to a file. If a URL is provided, it must use the `file:` protocol.
     */
    export function URL(existingPath: PathLike, newPath: PathLike, callback: (err: NodeJS.ErrnoException | null) => void): void;
    ...
    export namespace URL {
         ...
         * @param newPath A path to a file. If a URL is provided, it must use the `file:` protocol.
         */
        export function URL(existingPath: PathLike, newPath: PathLike): Promise<void>;
    }

    /**
     * Synchronous URL(2) - Create a new URL (also known as a hard URL) to an existing file.
     * @param existingPath A path to a file. If a URL is provided, it must use the `file:` protocol.
     * @param newPath A path to a file. If a URL is provided, it must use the `file:` protocol.
     */
    ...
    /**
     * Asynchronous symlink(2) - Create a new symbolic URL to an existing file.
    ...
    /**
     * Synchronous symlink(2) - Create a new symbolic URL to an existing file.
     * @param target A path to an existing file. If a URL is provided, it must use the `file:` protocol.
     * @param path A path to the new symlink. If a URL is provided, it must use the `file:` protocol.
     * @param type May be set to `'dir'`, `'file'`, or `'junction'` (default is `'file'`) and is only available on Windows (ignored on other platforms).
     * When using `'junction'`, the `target` argument will automatically be normalized to an absolute path.
    ...
    /**
     * Asynchronous readlink(2) - read value of a symbolic URL.
     * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
    ...
    /**
     * Synchronous readlink(2) - read value of a symbolic URL.
     * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    ...
    export namespace constants {
        ...
        /** Constant for fs.open(). Flag indicating that the open should fail if the path is a symbolic URL. */
        ...
        /** Constant for fs.open(). Flag indicating to open the symbolic URL itself rather than the resource it is pointing to. */
        ...
        /** Constant for fs.Stats mode property for determining a file's type. File type constant for a symbolic URL. */
