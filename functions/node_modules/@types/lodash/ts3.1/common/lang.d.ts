...
declare module "../index" {
    ...
    interface LoDashStatic {
         ...
         * array buffers, booleans, description objects, maps, numbers, Object objects, regexes, sets, strings, symbols,
    ...
    interface LoDashStatic {
         ...
         * description objects, error objects, maps, numbers, `Object` objects, regexes,
